...
<%
		 ...
		 s_num = request("num")
					...
					SQL = "SELECT TOP 1 * FROM D_GYPT WHERE NAME = '" & S_name & "'"
...
<body bgcolor="white">
<div align="center"><font color="#0000FF" class="main">（全国购药平台信息）疾病系统增加 </font></div>
<hr>
