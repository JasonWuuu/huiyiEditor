...
'查询
	...
	SQL = "SELECT SUM(READ_NUM) AS t, user_name AS c FROM A_ARTICLE where RE_date>='" & request("e_date1") & "' and RE_date<='" & request("e_date2") & "'  GROUP BY USER_NAME ORDER BY T DESC"
	RS.Open SQL,CONN,1,1	
%>

<html>
<head>
<title>点击查询（分人员）</title>
...
<body bgcolor="#FFFFFF">
<p align="center" class="main"><font color="#CC0000">分人员点击统计（<%=request("e_date1") %>）至（<%=request("e_date2") %>）</font>
<hr width="800" size="1">
<br>
<table width="800" border="1" cellspacing="0" cellpadding="0" align="center" bordercolor="#999999" bordercolorlight="#FFFFFF" class="main">
  <tr> 
    <td width="151"><font color="#0000CC">人员名称</font></td>
