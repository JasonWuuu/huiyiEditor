...
img {vertical-align:middle}
		...
		<b><font size="+2"><%=RS("INFO_TITLE")%></font></b><p>
		 ...
		 <%=rs("info_source")%>
		 		<p></p>
	  <img src="http://img.dakayi.cc/pic/<%=rs("info_file")%>" width="100%">
	  <font size="3">
		<%
...
<hr>
<font size="3">
<p style='text-indent: 2em; text-align: justify; line-height: 1.5em; margin-bottom: 15px; margin-top: 15px;'>    <span style='color: rgb(0, 0, 0); font-family: 微软雅黑, 'Microsoft YaHei';'>		 Android客户端下载：</span></p></font>
<img src="http://wap.dakayi.cc/images/a1.png" width="100%">
<p></p>
<font size="3">
<p style='text-indent: 2em; text-align: justify; line-height: 1.5em; margin-bottom: 15px; margin-top: 15px;'>    <span style='color: rgb(0, 0, 0); font-family: 微软雅黑, 'Microsoft YaHei';'>	特别提示：由于Android版微信在屏幕中出现多个二维码时总是识别当前屏幕中最后一个二维码，因此Android微信用户在长按识别二维码时，请确保【所需要识别的二维码完整显示并处于当前屏幕的最下方】。iOS用户不受影响，只需长按所需识别二维码即可。</span></p></font>
<hr>
<font size="3">
<p style='text-indent: 2em; text-align: justify; line-height: 1.5em; margin-bottom: 15px; margin-top: 15px;'>    <span style='color: rgb(0, 0, 0); font-family: 微软雅黑, 'Microsoft YaHei';'>	iOS客户端下载：</span></p></font>
...
<hr>
<font size="3">
<p style='text-indent: 2em; text-align: justify; line-height: 1.5em; margin-bottom: 15px; margin-top: 15px;'>    <span style='color: rgb(0, 0, 0); font-family: 微软雅黑, 'Microsoft YaHei';'>	
关注微信公众号：</span></p></font>
