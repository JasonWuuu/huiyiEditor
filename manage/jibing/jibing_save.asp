...
<%
		...
		s_jbzs = request("jbzs")
					...
					SQL = "SELECT TOP 1 * FROM JIBING WHERE JB_NAME = '" & s_jb_name & "' and fd_no = '" & s_fd_no & "'"
		...
		YY = ""
			SQL1 = "SELECT * FROM D_CLASS WHERE FD_NO = '" & S_fd_no & "'"
				...
				RS1.CLOSE 
						...
						SQL = "SELECT top 1 * FROM JIBING  WHERE JB_NO = '" & WB_FILE_NO & "'"
...
<body bgcolor="white">
<div align="center"><font color="#0000FF" class="main">（内部资料系统管理）疾病系统增加 </font></div>
<hr>
<form method="POST" action="jibing_main.asp" name="un" >
  <table width="580" border="0" bordercolordark="#99CCFF" bordercolorlight="#99CCFF" cellspacing="1" align="center" cellpadding="6" bgcolor="#000000">
    <tr bgcolor="#FFFFFF"> 
	  ...
	  <tr bgcolor="#FFFFFF"> 
      <td width="21%" class="main">疾病系统：</td>
    ...
    <tr bgcolor="#FFFFFF"> 
     ...
     <tr bgcolor="#FFFFFF"> 
      ...
      <td width="68%" class="main"> 
     http://www.dakayi.net/jibing/J<%=WB_FILE_NO%>.html
