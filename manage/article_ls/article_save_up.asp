					...
					s_info_desc=replace(s_info_desc,chr(13),XTHJW & XTH)
					 s_info_desc = XTH & s_info_desc & XTHJW
	  				...
	  				RS1("info_source") = s_info_source
						...
						RS1("user_name") = s_user_name
						RS1.UpdateBatch 
	  				RS1.Close 
	  	
'处理相关信息
				
				if Request("fabu") <> "" Then
				
				
sql = "select top 1 * from a_article_ls where info_no = '" & request("info_no") & "' and status='未'"
