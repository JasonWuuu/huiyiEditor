...
<%
		 ...
		 s_ysgs = request("zw") & "，" & Request("zhc") & "，" & Request("zc") & "，" & Request("xs") & "，" & Request("rwgs") 
		 s_rwgs = request("rwgs")
...
<form method="POST" action="doctor_main.asp" name="un" >
  <table width="1180" border="0" bordercolordark="#99CCFF" bordercolorlight="#99CCFF" cellspacing="1" align="center" cellpadding="6" bgcolor="#000000">
	 ...
	 <tr bgcolor="#FFFFFF"> 
      ...
      <td width="79%" class="main"> 
         <%=s_XSZW_ZZ%>
	 	  	 ...
	 	  	 <tr bgcolor="#FFFFFF"> 
      <td width="21%" class="main">项目成果：国际级：</td>
      <td width="79%" class="main"> 
         <%=s_XMCG_GJ%>
          </td>
    </tr>
	 	 <tr bgcolor="#FFFFFF"> 
      <td width="21%" class="main">项目成果：国家级：</td>
      <td width="79%" class="main"> 
         <%=s_XMCG_GJA%>
          </td>
    </tr>
	 	 <tr bgcolor="#FFFFFF"> 
      <td width="21%" class="main">项目成果：省市级：</td>
      <td width="79%" class="main"> 
         <%=s_XMCG_SS%>
          </td>
    </tr>
	  <tr bgcolor="#FFFFFF"> 
      <td width="21%" class="main">项目成果：院校级：</td>
      <td width="79%" class="main"> 
           <%=s_XMCG_YX%>
          </td>
    </tr>
    ...
    <tr bgcolor="#FFFFFF"> 
	 ...
	 <tr bgcolor="#FFFFFF"> 
      <td width="21%" class="main">是否首席：</td>
      <td width="79%" class="main"> 
       <%=s_sfsx%>
      </td>
    </tr>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="21%" class="main">北大本地排名：</td>
      <td width="79%" class="main"> 
		 <%=s_bj_bd_pm%>
       </td>
    </tr>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="21%" class="main">JCI本地排名：</td>
      <td width="79%" class="main"> 
		 <%=s_jci_bd_pm%>
       </td>
    </tr>
