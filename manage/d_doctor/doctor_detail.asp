  ...
  <table width="1180" border="0" bordercolordark="#99CCFF" bordercolorlight="#99CCFF" cellspacing="1" align="center" cellpadding="6" bgcolor="#000000">
    <tr bgcolor="#FFFFFF"> 
	 ...
	 <tr bgcolor="#FFFFFF"> 
      ...
      <td width="79%" class="main"> 
		 <img src="http://img.huiyi.net/zp/<%=rs("zp")%>"><font color=red>输入名次就可以了，FTP上传，制作小的图片400X600的，可以为空</font>
       </td>
    </tr>
    ...
    <tr bgcolor="#FFFFFF"> 
	 ...
	 <tr bgcolor="#FFFFFF"> 
      <td width="32%" class="main">挂号地址：</td>
      <td width="68%" class="main"> 
    <a href='<%=rs("send_url")%>'><%=rs("send_url")%></a>
