...
<form method="post" action="a_zhuanti_search.asp" name="un">
  ...
  <table width="898" border="0" bordercolordark="#99CCFF" bordercolorlight="#99CCFF" cellspacing="1" align="center" cellpadding="6" bgcolor="#000000" class="main">
    <tr bgcolor="#CCCCCC"> 
      ...
      <td width="9%"><font color="#0000FF">专题名称</font></td>
      <td width="11%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="12%"> 
        <div align="center"> <font color="#000000"><%
                ...
                %><a href="a_zhuanti_search.asp?zt_name=<%=request("zt_name")%>&PageNo=<%=PageNo-1%>&search=all">上一页 
          </a> <%
                ELSE
                %> 上一页 <%
                END IF
      ...
      <td width="12%"> 
        <div align="center"> <font color="#000000"><%
                ...
                %> <a href="a_zhuanti_search.asp?zt_name=<%=request("zt_name")%>&PageNo=<%=PageNo+1%>&search=all">下一页 
         </a> <%
                ELSE
                %> 下一页 <%
                END IF
