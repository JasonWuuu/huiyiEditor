...
<form method="post" action="a_class_search.asp" name="un">
  ...
  <table width="898" border="0" bordercolordark="#99CCFF" bordercolorlight="#99CCFF" cellspacing="1" align="center" cellpadding="6" bgcolor="#000000" class="main">
    <tr bgcolor="#CCCCCC"> 
      ...
      <td width="11%"> 
        <div align="center"><font color="#0000FF">排序</font></div>
      </td>
	   <td width="11%"> 
        <div align="center"><font color="#0000FF">订阅</font></div>
      </td>
      <td width="11%"> 
        <div align="center"><font color="#0000FF">类别图标</font></div>
      </td>
    </tr>
    <%
		'判断显示的总页数
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="12%"> 
        <div align="center"> <font color="#000000"><%
                ...
                %><a href="a_class_search.asp?class_no=<%=request("class_no")%>&class_name=<%=request("class_name")%>&PageNo=<%=PageNo-1%>&search=all">上一页 
          </a> <%
                ELSE
                %> 上一页 <%
                END IF
      ...
      <td width="12%"> 
        <div align="center"> <font color="#000000"><%
                ...
                %> <a href="a_class_search.asp?class_no=<%=request("class_no")%>&class_name=<%=request("class_name")%>&PageNo=<%=PageNo+1%>&search=all">下一页 
         </a> <%
                ELSE
                %> 下一页 <%
                END IF
