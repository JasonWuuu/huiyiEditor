...
'判断文章的相关字符
	SQL = "SELECT TOP 1 * FROM FDKSPM WHERE HS_NO='" & s_hs_NO & "' AND FD_NAME = '" & S_FD_NAME & "' and id <>" & request("id")
...
<body bgcolor="white">
<div align="center"><font color="#0000FF" class="main">（内部资料系统管理）科室排名系统修改 </font></div>
<hr>
