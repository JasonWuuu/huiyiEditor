...
<%
	...
	SQL = "SELECT  * FROM D_DOCTOR_DESC WHERE NO <> '' AND USER_NAME = '" & REQUEST("US") & "' AND CAOZUO='修改' AND RE_DATE>='" & DATE & "' ORDER BY ID"
  ...
  <table width="898" border="0" bordercolordark="#99CCFF" bordercolorlight="#99CCFF" cellspacing="1" align="center" cellpadding="6" bgcolor="#000000" class="main">
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="21%" height="34"> 
        <div align="center"><a href="doctor_detail.asp?id=<%=RS("id")%>" target='blank'><%=RS("xm")%></a></div>
      </td>
		 <td width="21%" height="34"> 
